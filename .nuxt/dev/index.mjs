globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/projects/nuxt-unocss/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'http';
import { tmpdir } from 'os';
import { join as join$1 } from 'path';
import { mkdirSync } from 'fs';
import { parentPort, threadId } from 'worker_threads';
import { provider, isWindows } from 'file:///home/projects/nuxt-unocss/node_modules/std-env/dist/index.mjs';
import { createRenderer } from 'file:///home/projects/nuxt-unocss/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { eventHandler, defineEventHandler, handleCacheHeaders, createEvent, useQuery, useCookie, getQuery, createError, defineLazyEventHandler, useBody, createApp, createRouter, lazyEventHandler } from 'file:///home/projects/nuxt-unocss/node_modules/h3/dist/index.mjs';
import devalue from 'file:///home/projects/nuxt-unocss/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/projects/nuxt-unocss/node_modules/vue/server-renderer/index.mjs';
import { parseURL, withQuery, withLeadingSlash, withoutTrailingSlash, joinURL } from 'file:///home/projects/nuxt-unocss/node_modules/ufo/dist/index.mjs';
import destr from 'file:///home/projects/nuxt-unocss/node_modules/destr/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/projects/nuxt-unocss/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/projects/nuxt-unocss/node_modules/ohmyfetch/dist/node.mjs';
import { createRouter as createRouter$1 } from 'file:///home/projects/nuxt-unocss/node_modules/radix3/dist/index.mjs';
import { createCall, createFetch } from 'file:///home/projects/nuxt-unocss/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/projects/nuxt-unocss/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///home/projects/nuxt-unocss/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/projects/nuxt-unocss/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/projects/nuxt-unocss/node_modules/unstorage/dist/drivers/fs.mjs';
import { extname, join } from 'file:///home/projects/nuxt-unocss/node_modules/pathe/dist/index.mjs';
import defu from 'file:///home/projects/nuxt-unocss/node_modules/defu/dist/defu.mjs';
import { unified } from 'file:///home/projects/nuxt-unocss/node_modules/unified/index.js';
import { toString } from 'file:///home/projects/nuxt-unocss/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/projects/nuxt-unocss/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/projects/nuxt-unocss/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/projects/nuxt-unocss/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/projects/nuxt-unocss/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/projects/nuxt-unocss/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/projects/nuxt-unocss/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/projects/nuxt-unocss/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/projects/nuxt-unocss/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/projects/nuxt-unocss/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/projects/nuxt-unocss/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/projects/nuxt-unocss/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/projects/nuxt-unocss/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/projects/nuxt-unocss/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/projects/nuxt-unocss/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/projects/nuxt-unocss/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/projects/nuxt-unocss/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/projects/nuxt-unocss/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/projects/nuxt-unocss/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/projects/nuxt-unocss/node_modules/detab/index.js';
import { u } from 'file:///home/projects/nuxt-unocss/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/projects/nuxt-unocss/node_modules/mdurl/index.js';
import { position } from 'file:///home/projects/nuxt-unocss/node_modules/unist-util-position/index.js';
import htmlTags from 'file:///home/projects/nuxt-unocss/node_modules/html-tags/index.js';
import slugify from 'file:///home/projects/nuxt-unocss/node_modules/slugify/slugify.js';
import { visit } from 'file:///home/projects/nuxt-unocss/node_modules/unist-util-visit/index.js';
import { getHighlighter, BUNDLED_LANGUAGES, BUNDLED_THEMES } from 'file:///home/projects/nuxt-unocss/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file:///home/projects/nuxt-unocss/node_modules/unenv/runtime/npm/consola.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"routes":{},"envPrefix":"NUXT_"},"public":{"content":{"base":"_content","tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":{"theme":"material-palenight","preload":["vue-html","json","bash","ts","tsx","js","jsx","yaml","graphql","md","svelte","astro"],"apiURL":"/api/_content/highlight"},"wsUrl":"ws://localhost:4000/","documentDriven":{"page":true,"navigation":true,"surround":true,"globals":{},"layoutFallbacks":["theme"],"injectPage":true}}},"content":{"cacheVersion":2,"cacheIntegrity":"iW1zZeFUxV","transformers":["/home/projects/nuxt-unocss/node_modules/@nuxt/content/dist/runtime/transformers/shiki.mjs"],"base":"_content","watch":{"ws":{"port":4000,"showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"highlight":{"theme":"material-palenight","preload":["vue-html","json","bash","ts","tsx","js","jsx","yaml","graphql","md","svelte","astro"],"apiURL":"/api/_content/highlight"},"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"toc":{"depth":3,"searchDepth":3},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":["layout"]},"documentDriven":true}};
...
const serverAssets = [{"baseName":"server","dir":"/home/projects/nuxt-unocss/server/assets"}];
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/projects/nuxt-unocss/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/projects/nuxt-unocss/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/home/projects/nuxt-unocss","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/home/projects/nuxt-unocss/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/home/projects/nuxt-unocss/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/home/projects/nuxt-unocss/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!html) {
    const { template } = await import('file:///home/projects/nuxt-unocss/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/projects/nuxt-unocss/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const node_modules__64nuxt_content_dist_runtime_transformers_shiki_mjs_xGLBRVDLhb = defineTransformer({
  name: "highlight",
  extensions: [".md"],
...
const transformers = [node_modules__64nuxt_content_dist_runtime_transformers_shiki_mjs_xGLBRVDLhb];
...
const _Q5hbsd = defineEventHandler(async (event) => {
...
const _AEr0jd = defineEventHandler(async (event) => {
  const now = Date.now();
...
const _m7UMtM = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _Nh96Lw = defineLazyEventHandler(async () => {
...
const _lazy_9Mwoon = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_9Mwoon, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid', handler: _Q5hbsd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _Q5hbsd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache', handler: _AEr0jd, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _m7UMtM, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _m7UMtM, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/highlight', handler: _Nh96Lw, lazy: false, middleware: false, method: "post" },
  { route: '/**', handler: _lazy_9Mwoon, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/projects/nuxt-unocss/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('/home/projects/nuxt-unocss/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
